/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a85e9a01d9ce6d04a6a5c17793573d8c)
...
declare namespace Cloudflare {
	interface Env {
		...
		ZOHO_USERNAME: string;
		ZOHO_PASSWORD: string;
		Lumenize: DurableObjectNamespace<import("./src/lumenize-worker").Lumenize>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_DEFAULT_REGION" | "ZOHO_USERNAME" | "ZOHO_PASSWORD">> {}
}
