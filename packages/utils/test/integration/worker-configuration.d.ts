/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config test/integration/wrangler.jsonc test/integration/worker-configuration.d.ts` (hash: 6a6d6f5694ede7d1b70783f6c55b5099)
// Runtime types generated with workerd@1.20251001.0 2025-09-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test-worker-and-dos");
		durableNamespaces: "TestDO" | "MyDO" | "UserSession";
	}
	interface Env {
		TEST_DO: DurableObjectNamespace<import("./test-worker-and-dos").TestDO>;
		MY_DO: DurableObjectNamespace<import("./test-worker-and-dos").MyDO>;
		USER_SESSION: DurableObjectNamespace<import("./test-worker-and-dos").UserSession>;
	}
}
