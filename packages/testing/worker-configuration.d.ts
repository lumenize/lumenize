/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config test/wrangler.jsonc` (hash: eaf46a5ef6c4d1ee56640dfd9ab917eb)
// Runtime types generated with workerd@1.20251008.0 2025-09-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test/test-harness");
		durableNamespaces: "TestDOWithRpc" | "ActorAlarmsDO";
	}
	interface Env {
		TEST_DO: DurableObjectNamespace<import("./test/test-harness").TestDOWithRpc>;
		ACTOR_ALARMS_DO: DurableObjectNamespace<import("./test/test-harness").ActorAlarmsDO>;
	}
}
