/**
 * Test DO that extends Actor from @cloudflare/actors
 * This validates that our alarm simulation works with Actor's multiplexed alarms
 */
import { Actor } from "@cloudflare/actors";
import { type Schedule } from "@cloudflare/actors/alarms";

export class ActorAlarmsDO extends Actor<Env> {
