/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9da7460f9fe784da3ffb7e3989a1951c)
// Runtime types generated with workerd@1.20251011.0 2025-09-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test/test-worker-and-dos");
		durableNamespaces: "ExampleDO" | "ManualRoutingDO" | "SubclassDO" | "PipeliningDO" | "MyDO" | "NotificationDO" | "VideoDO" | "NotificationHub" | "DocumentDO" | "BroadcastDO" | "MapSetTestDOWithRpc" | "DebugDOWithRpc";
	}
	interface Env {
		TEST_TOKEN: string;
		...
		PRIMARY_JWT_KEY: string;
		EXAMPLE_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").ExampleDO>;
		SUBCLASS_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").SubclassDO>;
		MANUAL_ROUTING_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").ManualRoutingDO>;
		PIPELINING_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").PipeliningDO>;
		MY_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").MyDO>;
		NOTIFICATION_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").NotificationDO>;
		VIDEO_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").VideoDO>;
		NOTIFICATIONS: DurableObjectNamespace<import("./test/test-worker-and-dos").NotificationHub>;
		DOCUMENT_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").DocumentDO>;
		BROADCAST_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").BroadcastDO>;
		MAPSET_TEST_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").MapSetTestDOWithRpc>;
		DEBUG_DO: DurableObjectNamespace<import("./test/test-worker-and-dos").DebugDOWithRpc>;
	}
}
