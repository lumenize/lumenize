...
export const testCategories = {
  ...
  inspection: ['asObject'],
  async: ['slowIncrement'],
  webApi: ['echoHeaders', 'echoURL', 'echoDate', 'echoRegExp', 'echoMap', 'echoSet', 'echoArrayBuffer', 'echoTypedArray', 'echoError', 'echoCustomErrorClass', 'echoBigInt', 'echoSpecialNumbers'],
  storage: ['echoThroughStorageCircularReference', 'echoThroughStorageHeaders', 'echoThroughStorageURL', 'echoThroughStorageDate', 'echoThroughStorageRegExp', 'echoThroughStorageMap', 'echoThroughStorageSet', 'echoThroughStorageArrayBuffer', 'echoThroughStorageTypedArray', 'echoThroughStorageError', 'echoThroughStorageCustomErrorClass', 'echoThroughStorageBigInt', 'echoThroughStorageSpecialNumbers'],
};
