...
import { sharedDOMethods, createComplexData } from './shared/do-methods';
/**
 ...
 */
export class ManualRoutingDO extends DurableObject {
    #rpcConfig = {
        prefix: '/__rpc'
    };
    complexData;
    constructor(ctx, env) {
        ...
        this.ctx.setWebSocketAutoResponse(new WebSocketRequestResponsePair("auto-response ping", "auto-response pong"));
    }
...
//# sourceMappingURL=test-worker-and-dos.js.map