/**
 * OCAN (Operation Chaining And Nesting) for RPC
 *
 * This is a simplified copy of @lumenize/mesh OCAN for use in the RPC package.
 * It does NOT include mesh decorator support since RPC has a different security model.
 *
 * Attribution: Forked from @lumenize/mesh OCAN implementation.
 *
 * @internal
 */
