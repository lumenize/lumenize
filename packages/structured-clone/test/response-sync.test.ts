...
describe('ResponseSync', () => {
  ...
  describe('clone()', () => {
    ...
    it('creates shallow copy (body is shared reference)', () => {
      ...
      if (typeof cloned.body === 'object' && cloned.body !== null && !(cloned.body instanceof ArrayBuffer)) {
  ...
  describe('Round-trip Serialization', () => {
    it('handles simple ResponseSync round-trip', async () => {
      ...
      const result = parse(stringify(responseSync));
    ...
    it('handles ResponseSync in arrays round-trip', async () => {
      ...
      const result = parse(stringify(responses));
