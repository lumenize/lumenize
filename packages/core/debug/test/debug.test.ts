...
describe('@lumenize/core - debug', () => {
  ...
  // Note: Namespace filtering tests removed - tested internal implementation details

  // Note: Level filtering tests removed - tested internal implementation details

  // Note: Pattern matching edge case tests removed - tested internal implementation details
});
