...
Change `auth@example.com` to an address on the domain you onboarded in 8a. That's it — `CloudflareEmailSender` handles delivery, default HTML templates, and subject lines. No API key to manage.
