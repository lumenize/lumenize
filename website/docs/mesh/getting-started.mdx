...
## (Recommended) Step 8: Configure Turnstile and Rate Limiting {#turnstile-and-rate-limiting}

Turnstile and rate limiting are optional so you can get started quickly, but you should enable both before deploying to production. See [@lumenize/auth: Rate Limiting](/docs/auth/getting-started#rate-limiting) for setup instructions and why they matter.
