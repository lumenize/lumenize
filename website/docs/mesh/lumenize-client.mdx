...
`@lumenize/auth` issues the JWT and defines the [`JwtPayload`](../auth/) shape. If your auth provider mints additional claims, declare them in a module augmentation alongside your client code.
