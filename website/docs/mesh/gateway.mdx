...
The Gateway and Client communicate over WebSocket using JSON messages. For complete message type definitions and serialization format details, see the [Protocol Specification](./protocol#websocket-wire-protocol).
