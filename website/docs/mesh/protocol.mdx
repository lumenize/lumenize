...
interface CallContext {
  ...
  /** HTTP facts of the originating upgrade, stamped by the Gateway — client-originated chains only (immutable) */
...
| `callContext.originRequest` | Native | JSON (plain strings) |
