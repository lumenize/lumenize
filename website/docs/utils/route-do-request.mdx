...
- [getDONamespaceFromPathSegment API](/docs/utils/api/functions/getDONamespaceFromPathSegment)
- [RPC Quick Start](/docs/rpc/quick-start) - Uses `routeDORequest` internally
