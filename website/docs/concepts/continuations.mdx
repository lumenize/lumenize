...
:::tip Key Concept
A continuation is a **description of future work** that gets executed in some other place and/or time usually during/after some native async operation. It maintains DO consistency by keeping the handler synchronous.
:::
