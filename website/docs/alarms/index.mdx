...
De✨light✨ful alarm scheduling for Cloudflare Durable Objects using [continuations](/docs/concepts/continuations). Multiplexes single native alarm to give you unlimited scheduled tasks.

## Features

- **[Continuations](/docs/concepts/continuations)** - Type-safe, serializable task handlers
...
- **[Continuations](/docs/concepts/continuations)** - Understanding the continuation pattern
