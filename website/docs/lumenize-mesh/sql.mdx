...
:::tip Core Utility
This is a small (~10 lines), universally useful utility from `@lumenize/core` that's automatically available via NADIS when using LumenizeDO.
:::
...
For vanilla Durable Objects without the Lumenize Mesh, create a private field:
...
- [LumenizeDO](./lumenize-do) - Auto-injection via NADIS
