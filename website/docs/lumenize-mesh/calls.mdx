...
:::warning Avoid using Cloudflare-native Workers RPC
Use `this.lmz.call()` instead of Cloudflare's native Workers RPC. It provides automatic context propagation, access control mechanisms, and works seamlessly with browser clients.
:::
