...
The Worker routes requests to DOs and handles authentication. See [Security: Installation & Setup](./security#installation--setup) for key generation, environment variables, and production configuration.
