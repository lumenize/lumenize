...
```typescript @check-example('packages/mesh/test/for-docs/mesh/document-do.ts')
...
```typescript @check-example('packages/mesh/test/for-docs/mesh/spell-check-worker.ts')
...
```typescript @check-example('packages/mesh/test/for-docs/mesh/editor-client.ts')
...
```typescript @check-example('packages/mesh/test/for-docs/mesh/getting-started.test.ts')
// ...
...
```typescript @check-example('packages/mesh/test/for-docs/mesh/index.ts')
...
```jsonc @check-example('packages/mesh/test/for-docs/mesh/wrangler.jsonc')
{
