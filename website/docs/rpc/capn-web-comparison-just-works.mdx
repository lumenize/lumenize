...
`@lumenize/mesh` now solves all of this with `LumenizeClient` — supporting
hibernating WebSockets, no dangling resources, and full bidirectional communication.
See the [Lumenize Mesh documentation](/docs/lumenize-mesh) for details.
