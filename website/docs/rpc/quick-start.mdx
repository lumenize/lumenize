...
We'll show it being used in a test, but it's a general purpose RPC framework that you can use in production as long as you secure it.
...
We're going to keep showing off the capabilities of @lumenize/rpc in the form
of a test. Note, everything shown here for WebSocket transport can be done with
