...
```jsonc title="wrangler.jsonc" @check-example('packages/proxy-fetch/test/queue/wrangler.jsonc')
{
...
```typescript title="src/my-do.ts" @check-example('packages/proxy-fetch/test/queue/test-worker-and-dos.ts')
...
```typescript title="src/index.ts" @check-example('packages/proxy-fetch/test/queue/test-worker-and-dos.ts')
...
```typescript @check-example('packages/proxy-fetch/test/queue/test-worker-and-dos.ts')
/**
