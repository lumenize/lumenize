...
A zero-dependency fork of `@ungap/structured-clone` with enhanced serialization for complex JavaScript types including cycles, Errors, Request/Response, special numbers, and more.
