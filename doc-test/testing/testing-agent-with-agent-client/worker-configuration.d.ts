/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61eccedf7baf0b1ce832bc04e32fbdb6)
// Runtime types generated with workerd@1.20251008.0 2025-09-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChatAgent" | "AuthAgent";
	}
	interface Env {
		SESSION_STORE: KVNamespace;
		CHAT_AGENT: DurableObjectNamespace<import("./src/index").ChatAgent>;
		AUTH_AGENT: DurableObjectNamespace<import("./src/index").AuthAgent>;
	}
}
