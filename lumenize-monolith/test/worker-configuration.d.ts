/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 90b3c74c8b156cd42f0967ef2da2f5b9)
// Runtime types generated with workerd@1.20250617.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		TestHarnessDO: DurableObjectNamespace<import("./test-harness").TestHarnessDO>;
		Lumenize: DurableObjectNamespace<import("./test-harness").TestHarnessDO>;
		LUMENIZE: Fetcher /* lumenize */;
