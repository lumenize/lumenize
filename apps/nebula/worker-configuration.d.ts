/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e618a5ac358aa88c100e1e96e892077f)
// Runtime types generated with workerd@1.20260710.1 2026-04-01 nodejs_compat
interface __BaseEnv_Env {
	REFRESH_TOKEN_KV: KVNamespace;
	EMAIL: SendEmail;
	NEBULA_AUTH_RATE_LIMITER: RateLimit;
	NEBULA_AUTH_CONNECTION_RATE_LIMITER: RateLimit;
	LOADER: WorkerLoader;
	AI: Ai;
	ASSETS: Fetcher;
	...
	CLOUDFLARE_LOG_QUERY_TOKEN: string;
	CLOUDFLARE_R2_LOGPUSH_URL: string;
	...
	NEBULA_AUTH_BOOTSTRAP_EMAIL: string;
	SONAR_TOKEN: string;
	NEBULA_AUTH_TURNSTILE_BYPASS_TOKEN: string;
	NEBULA_CLIENT_GATEWAY: DurableObjectNamespace<import("./src/worker").NebulaClientGateway>;
	UNIVERSE: DurableObjectNamespace<import("./src/worker").Universe>;
	GALAXY: DurableObjectNamespace<import("./src/worker").Galaxy>;
	STAR: DurableObjectNamespace<import("./src/worker").Star>;
	DEV_STUDIO: DurableObjectNamespace<import("./src/worker").DevStudio>;
	DEV_CONTAINER: DurableObjectNamespace<import("./src/worker").DevContainer>;
	NEBULA_AUTH_REGISTRY: DurableObjectNamespace<import("./src/worker").NebulaAuthRegistry>;
	PROFILE: DurableObjectNamespace<import("./src/worker").Profile>;
	AUTH_EMAIL_SENDER: Service<typeof import("./src/worker").NebulaEmailSender>;
	NEBULA_AUTH_FACADE: Service<typeof import("./src/worker").NebulaAuthFacade>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "NebulaClientGateway" | "Universe" | "Galaxy" | "Star" | "DevStudio" | "DevContainer" | "NebulaAuthRegistry" | "Profile";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRIMARY_JWT_KEY" | "NEBULA_AUTH_REDIRECT" | "DEBUG" | "AUTH_EMAIL_FROM" | "LUMENIZE_APPROVED_ORIGINS" | "TEST_TOKEN" | "TEST_ENDPOINTS_URL" | "CLOUDFLARE_LOG_QUERY_TOKEN" | "CLOUDFLARE_R2_LOGPUSH_URL" | "CLOUDFLARE_R2_BUCKET_NAME" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_R2_ACCESS_KEY_ID" | "CLOUDFLARE_R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_GLOBAL_API_KEY" | "JWT_PRIVATE_KEY_BLUE" | "JWT_PUBLIC_KEY_BLUE" | "JWT_PRIVATE_KEY_GREEN" | "JWT_PUBLIC_KEY_GREEN" | "RESEND_API_KEY" | "ANTHROPIC_API_KEY" | "WORKERS_AI_TOKEN" | "NEBULA_AUTH_BOOTSTRAP_EMAIL" | "SONAR_TOKEN" | "NEBULA_AUTH_TURNSTILE_BYPASS_TOKEN">> {}
}
