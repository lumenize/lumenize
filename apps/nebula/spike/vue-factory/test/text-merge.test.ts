/**
 * textMerge property tests — the isolation harness for the pure-helper detour
 * (`tasks/factory-textmerge.md` § Property tests; no mock-client needed).
 * Each `describe` maps to one pinned property from the spec.
 */
