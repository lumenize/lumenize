 ...
 * `tasks/factory-collection-sync.md`, against the shared write-capture
 * harness (MockClient + the debounce queue at quietMs 0 so rapid mutations
 * coalesce on a microtask). Each `it` maps to one item of the spec's
 * checklist.
 */
