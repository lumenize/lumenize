/**
 * vitest setup — bump vi.waitFor default timeout from 1000ms to 5000ms.
 * Mirrors the baseline test-app's setup; under parallel contention the
 * 1s default is fragile for any test that hits real network/DO bindings.
 */
