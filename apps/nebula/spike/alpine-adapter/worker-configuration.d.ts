/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config test/wrangler.jsonc` (hash: 0cff5b3918998c930db2ac3989147ecb)
// Runtime types generated with workerd@1.20260426.1 2026-04-01 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test/test-harness");
	...
	interface Env {
		...
		NEBULA_CLIENT_GATEWAY: DurableObjectNamespace<import("./test/test-harness").NebulaClientGateway>;
		UNIVERSE: DurableObjectNamespace<import("./test/test-harness").Universe>;
		GALAXY: DurableObjectNamespace<import("./test/test-harness").Galaxy>;
		STAR: DurableObjectNamespace<import("./test/test-harness").Star>;
		RESOURCE_HISTORY: DurableObjectNamespace<import("./test/test-harness").ResourceHistory>;
		NEBULA_AUTH: DurableObjectNamespace<import("./test/test-harness").NebulaAuth>;
		NEBULA_AUTH_REGISTRY: DurableObjectNamespace<import("./test/test-harness").NebulaAuthRegistry>;
		AUTH_EMAIL_SENDER: Service<typeof import("./test/test-harness").NebulaEmailSender>;
	}
}
