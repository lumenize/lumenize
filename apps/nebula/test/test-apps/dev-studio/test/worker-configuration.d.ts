/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f379787cce458aaa4262660d6fd1ee9b)
...
interface __BaseEnv_Env {
	...
	GALAXY: DurableObjectNamespace<import("../index").GalaxyLoopProbe>;
	GALAXY_DEADLINE: DurableObjectNamespace<import("../index").GalaxyDeadlineProbe>;
	STAR: DurableObjectNamespace<import("../index").DevStarOntologyProbe>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../index");
		durableNamespaces: "GalaxyLoopProbe" | "GalaxyDeadlineProbe" | "DevStarOntologyProbe";
	}
