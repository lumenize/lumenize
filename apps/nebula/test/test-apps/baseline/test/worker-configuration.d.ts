/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e027659d1a37207536f8baccb30939f7)
...
interface __BaseEnv_Env {
	...
	NEBULA_CLIENT_GATEWAY: DurableObjectNamespace<import("./test-harness").NebulaClientGateway>;
	UNIVERSE: DurableObjectNamespace<import("./test-harness").Universe>;
	GALAXY: DurableObjectNamespace<import("./test-harness").Galaxy>;
	STAR: DurableObjectNamespace<import("./test-harness").StarTest>;
	DEV_STUDIO: DurableObjectNamespace<import("./test-harness").DevStudioTest>;
	DEV_CONTAINER: DurableObjectNamespace<import("./test-harness").DevContainerServeStub>;
	NEBULA_AUTH_REGISTRY: DurableObjectNamespace<import("./test-harness").NebulaAuthRegistry>;
	PROFILE: DurableObjectNamespace<import("./test-harness").ProfileTest>;
	AUTH_EMAIL_SENDER: Service<typeof import("./test-harness").NebulaEmailSender>;
	NEBULA_AUTH_FACADE: Service /* entrypoint NebulaAuthFacade from nebula-baseline-test */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test-harness");
		durableNamespaces: "NebulaClientGateway" | "Universe" | "Galaxy" | "StarTest" | "DevStudioTest" | "DevContainerServeStub" | "NebulaAuthRegistry" | "ProfileTest";
	}
