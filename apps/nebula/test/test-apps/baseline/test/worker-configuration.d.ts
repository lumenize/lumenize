/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c948cc57f31c6ca08ebc604b5cc6d8c3)
...
interface __BaseEnv_Env {
	...
	GALAXY: DurableObjectNamespace<import("./test-harness").GalaxyTest>;
	...
	NEBULA_AUTH_FACADE: Service<typeof import("./test-harness").NebulaAuthFacade>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./test-harness");
		durableNamespaces: "NebulaClientGateway" | "Universe" | "GalaxyTest" | "StarTest" | "NebulaAuthRegistry" | "ProfileTest";
	}
