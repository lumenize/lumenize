/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33d2cf49974d115a7cd40eabd76524dc)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "NebulaClientGateway" | "Universe" | "Galaxy" | "StarTest" | "ResourceHistory" | "NebulaAuth" | "NebulaAuthRegistry";
	}
	interface Env {
		...
		RESOURCE_HISTORY: DurableObjectNamespace<import("./test-harness").ResourceHistory>;
		NEBULA_AUTH: DurableObjectNamespace<import("./test-harness").NebulaAuth>;
