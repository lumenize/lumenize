/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e794a6d05113c80845087ddf16d041c5)
...
interface __BaseEnv_Env {
	...
	NEBULA_CLIENT_GATEWAY: DurableObjectNamespace<import("./index").NebulaClientGateway>;
	UNIVERSE: DurableObjectNamespace<import("./index").Universe>;
	GALAXY: DurableObjectNamespace<import("./index").Galaxy>;
	STAR: DurableObjectNamespace<import("./index").StarTest>;
	NEBULA_AUTH_REGISTRY: DurableObjectNamespace<import("./index").NebulaAuthRegistry>;
	BenchAgent: DurableObjectNamespace<import("./index").BenchAgent>;
	AUTH_EMAIL_SENDER: Service<typeof import("./index").TestNebulaEmailSender>;
	LUMENIZE_BROADCAST_TIER: Service<typeof import("./index").BenchFanoutTier>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "NebulaClientGateway" | "Universe" | "Galaxy" | "StarTest" | "NebulaAuthRegistry" | "BenchAgent";
	}
