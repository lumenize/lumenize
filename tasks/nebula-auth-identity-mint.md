...
## Phases
🚧 **Phase 1 is released by [nebula-confine-admin-bypass.md](nebula-confine-admin-bypass.md) *Phase 1* only** — its Phases 2–3 are not prerequisites for this task.
...
## Relationships
- 🚧 **Phase 1 released by [nebula-confine-admin-bypass.md](nebula-confine-admin-bypass.md) Phase 1** — see that file's Relationships for the phase-granular condition (§2).
