...
**Status:** Active child, **gated on the collapse.** This is the only home for the collaborator: [nebula-auth-identity-mint.md](nebula-auth-identity-mint.md) ships the invite *mechanism* and names no role. Design pinned with Larry 2026-07-18/19; endpoint placement pinned 2026-08-05; not yet built.
...
- **[ADR-015](../docs/adr/015-scope-authority-flows-downward.md)** — authority flows downward only; authority is `admin` ∧ pattern-covers-this-node; restraint is a UI warning, never an authz refusal.
...
- **Changing the scope-pattern grammar** → [nebula-reach-from-scope.md](nebula-reach-from-scope.md), which owns it and lands first.

## Open questions

1. ✅ **Closed 2026-08-05** — *"accept tenant-Star admission, or change the pattern grammar?"* The grammar is being changed, by [nebula-reach-from-scope.md](nebula-reach-from-scope.md). Kept as a numbered handle so the remaining questions do not renumber.
