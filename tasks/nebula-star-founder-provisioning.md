...
5. The founder clicks it: the link is consumed, `emailVerified` flips, a refresh cookie is set, and they land on the app's own surface (**tier-derived redirect**, Phase 4).
