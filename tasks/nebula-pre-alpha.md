...
- **Provision-a-subject-into-{scope, role}** — Universe-admin invite (pre-provisioned slug+name +
  ...
  - ✅ **The dominion/passage/guards/invite spine is BUILT + archived:**
    ...
    [nebula-registry-scope-in-url.md](nebula-registry-scope-in-url.md) (**a candidate, not a
    commitment** — see ③; independent of the collapse in both directions; ⚠️ both edit
    `apps/nebula/src/nebula-client.ts`, different regions — do not interleave, a concurrency note,
    not an ordering one) and
