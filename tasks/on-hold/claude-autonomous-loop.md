...
- **act-as synthetic users** — impersonate provisioned synthetic subjects to exercise multi-user flows from one identity (builds on `delegated-token` + the Phase-3 `*` reach).
