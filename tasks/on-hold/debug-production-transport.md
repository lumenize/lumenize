...
**Status**: On hold — speculative; pick up when a real consumer asks (Sentry forwarder, Logflare, Workers Analytics Engine, custom dashboard).
**Related**:
