...
- **`on-hold/use-lumenize-dev-domain-and-support-custom-domains.md`** — mined and removed 2026-09-15. Its outbound-URL guard, Reset-data storage note and Storage Access API plan went to [sessions-per-origin.md](sessions-per-origin.md); its custom-domain ownership rule and a Precursor bot-detection idea went to [backlog.md](backlog.md).
