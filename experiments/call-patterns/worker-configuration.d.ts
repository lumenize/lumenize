/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe020bee6c9a26aa9db6afa60d46ce20)
// Runtime types generated with workerd@1.20251011.0 2025-09-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PatternController" | "RemoteDO";
	}
	interface Env {
		TEST_TOKEN: string;
		TEST_ENDPOINTS_URL: string;
		DEBUG: string;
		CONTROLLER: DurableObjectNamespace<import("./src/index").PatternController>;
