/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5c04abc8026bacdc8fbec03700c4b36)
// Runtime types generated with workerd@1.20251011.0 2025-09-12 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CallDelayController" | "RemoteDO";
	}
	interface Env {
		TEST_TOKEN: string;
		TEST_ENDPOINTS_URL: string;
		DEBUG: string;
		CONTROLLER: DurableObjectNamespace<import("./src/index").CallDelayController>;
		REMOTE_DO: DurableObjectNamespace<import("./src/index").RemoteDO>;
	}
}
