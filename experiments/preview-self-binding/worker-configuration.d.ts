/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58ac9db2e226d49edc89f974267f4723)
// Runtime types generated with workerd@1.20260921.1 2026-08-15
interface __BaseEnv_Env {
	MARKER: "production";
	COUNTER: DurableObjectNamespace<import("./src/worker").Counter>;
	SELF: Service<typeof import("./src/worker").Probe>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MARKER">> {}
}
