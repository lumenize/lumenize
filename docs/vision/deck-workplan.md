...
- **A real (tiny) demand signal worth stating out loud (2026-07-31).** Both prospective user-developers wanted a collaborator before writing a line: Jennifer wants Austen on Gigi's Almanac, Sydney wants Cass on the Secret Santa idea. Two for two, against a prior that said ~90% would work alone — which is why that estimate is now retired (`strategy.md` § *The positioning*). ⚠️ **Present it honestly as n=2 and as a hypothesis to test**, never as a finding; an investor who has seen a thousand decks will price an over-claimed n=2 worse than a candid one. What it does support, and what the *Why now* and GTM slides can lean on, is the shape: **the buyer is one person and the workspace is multiplayer**, so account expansion rides invitation rather than a sales motion (`enterprise.md` § *The invitation is the land motion*).
